...
import { EyeIcon, ClipboardIcon, ClockIcon, CheckIcon, EmployeesIcon, CalendarIcon, MoonIcon, ChartIcon } from '../components/Icons';
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <StatCard icon={<ClipboardIcon className="w-6 h-6" />} label="Total Primes" value={stats.total} sub={formatAmount(stats.totalAmount)} color="brand" />
        ...
        <StatCard icon={<EmployeesIcon className="w-6 h-6" />} label="Employés" value={stats.employees} sub="Actifs" color="violet" />
      </div>
